(function($) {
  ...
  $(document).on('click', '.logout', function() {
    ...
    var $btn = $(this);
    $.ajax({
      url: '/admin_old/member_update_point/' + $('input[name=idx]').val(),
    ...
    var $btn = $(this);
    $.ajax({
      url: '/admin_old/' + $('#messageModal input[name=action]').val(),
    ...
    if (flag == true) {
      ...
      $.ajax({
        ...
        success: function() {
          location.href=('/admin_old/setup_front');
        }
      });
    }
    ...
    if (error == 1) {
      ...
      $.ajax({
        ...
        success: function() {
          location.href=('/admin_old/setup_bustype');
        }
      });
    }
    ...
    var $btn = $(this);
    $.ajax({
      url: '/admin_old/main_wait_delete',
    ...
    $.ajax({
      url: '/admin_old/search_by_nickname',
    ...
    $.ajax({
      url: '/admin_old/main_wait_insert',
      data: data,
      dataType: 'json',
      type: 'post',
      beforeSend: function() {
    ...
    var selected = '';
    $.ajax({
      url: '/admin_old/reserve_information_bus',
    ...
    $.ajax({
      ...
      success: function(result) {
        ...
        if (result.error == 1) {
          ...
          location.replace('/admin_old/main_view_progress/' + $('input[name=idx]').val());
        }
      }
    });
    ...
    var $btn = $(this);
    $.ajax({
      url: '/admin_old/setup_bustype_hide',
      data: 'idx=' + $(this).data('idx'),
      dataType: 'json',
      type: 'post',
      beforeSend: function() {
  ...
  $.viewReserveInfo = function(resIdx, bus, seat) {
    ...
    var selected = '';
    $.ajax({
      url: '/admin_old/reserve_information',
