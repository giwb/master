...
<head>
    ...
    <link rel="stylesheet" href="/public/tripkorea/css/bootstrap.min.css">                                      
    <link rel="stylesheet" href="/public/tripkorea/css/hero-slider-style.css">                              
    <link rel="stylesheet" href="/public/tripkorea/css/magnific-popup.css">                                 
    <link rel="stylesheet" href="/public/tripkorea/css/templatemo-style.css">                                   

    <script src="/public/tripkorea/js/jquery-1.11.3.min.js"></script>
</head>
    ...
    <body>
        ...
        <div class="cd-hero">
            ...
            <div class="cd-slider-nav">
                <nav class="navbar">
                    <div class="tm-navbar-bg">
                        ...
                        <a class="navbar-brand" href="#">한국여행</a>
                        ...
                        <div class="collapse navbar-toggleable-md text-xs-center text-uppercase tm-navbar" id="tmNavbar">
                            <ul class="nav navbar-nav">
                                <li class="nav-item active selected">
                                    <a class="nav-link" href="#0" data-no="1">100대명산 <span class="sr-only">(current)</span></a>
                                </li>                                
                                <li class="nav-item">
                                    <a class="nav-link" href="#0" data-no="2">백두대간</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#0" data-no="3">도보트레킹</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#0" data-no="4">유명관광지</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#0" data-no="5">산악회</a>
                                </li>
                            </ul>
                        </div>                        
                    </div>
                                ...
                                <div class="tm-img-gallery">
                                    <div class="grid-item">
                                        <figure class="effect-sadie">
                                            <img src="http://tripkorea.net/public/photos/156764919843927.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                                <h2 class="tm-figure-title">가리산</h2>
                                                <p class="tm-figure-description">해발 1,051m<br>강원도 홍천군</p>
                                                <a target="_blank" href="http://tripkorea.net/place/view/31">더보기</a>
                                            </figcaption>           
                                        </figure>
                                    </div>
                                    <div class="grid-item">
                                        <figure class="effect-sadie">
                                            <img src="http://tripkorea.net/public/photos/156764923430348.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                                <h2 class="tm-figure-title">가리왕산</h2>
                                                <p class="tm-figure-description">해발 1,561m<br>강원도 정선군</p>
                                                <a target="_blank" href="http://tripkorea.net/place/view/32">더보기</a>
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="grid-item">
                                        <figure class="effect-sadie">
                                            <img src="http://tripkorea.net/public/photos/156764928173951.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                                <h2 class="tm-figure-title">가야산 상왕봉</h2>
                                                <p class="tm-figure-description">해발 1,430m<br>경상남도 거창군</p>
                                                <a target="_blank" href="http://tripkorea.net/place/view/33">더보기</a>
                                            </figcaption>           
                                        </figure>
                                    </div>
                                    <div class="grid-item">
                                        <figure class="effect-sadie">
                                            <img src="http://tripkorea.net/public/photos/156764934532891.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                                <h2 class="tm-figure-title">가지산</h2>
                                                <p class="tm-figure-description">해발 1,240m<br>울산광역시 울주군</p>
                                                <a href="img/tm-img-04.jpg">더보기</a>
                                            </figcaption>           
                                        </figure>
                                    </div>  
            ...
            <footer>
                <p class="tm-copyright-text">Copyright &copy; <span class="tm-copyright-year">current year</span>, SayHome
            </footer>
        ...
        <script src="/public/tripkorea/js/tether.min.js"></script> <!-- Tether (http://tether.io/)  --> 
        <script src="/public/tripkorea/js/bootstrap.min.js"></script>             <!-- Bootstrap js (v4-alpha.getbootstrap.com/) -->
        <script src="/public/tripkorea/js/hero-slider-main.js"></script>          <!-- Hero slider (https://codyhouse.co/gem/hero-slider/) -->
        <script src="/public/tripkorea/js/jquery.magnific-popup.min.js"></script> <!-- Magnific popup (http://dimsemenov.com/plugins/magnific-popup/) -->
