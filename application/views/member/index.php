        ...
        <div class="mypage mt-2">
          ...
          <form id="reserveForm" method="post" action="/reserve/payment">
            ...
            <dl>
              ...
              <dd>
                <?=viewStatus($value['notice_status'])?> <a href="<?=BASE_URL?>/reserve/<?=$value['resCode']?>"><?=$value['subject']?></a> - <?=checkDirection($value['seat'], $value['bus'], $value['notice_bustype'], $value['notice_bus'])?>번 좌석<br>
                <small>
