        ...
        <div class="memberForm">
          ...
          <input type="hidden" name="page" value="member">
            ...
            <dl>
              <dt>사진</dt>
              <dd>
                <img class="photo" src="<?=$viewMember['photo']?>"><input type="file" name="photo" class="file d-none"><button type="button" class="btn btn-info btn-upload">사진올리기</button><input type="hidden" name="filename"></dd>
            </dl>
            <div class="area-btn">
