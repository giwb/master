              ...
              <div class="story-reaction">
                ...
                <div class="area-share">
                  <ul>
                    ...
                    <li><a href="javascript:;" class="btn-share-sns" data-idx="<?=$value['idx']?>" data-reaction-type="<?=REACTION_TYPE_STORY?>" data-type="<?=SHARE_TYPE_KAKAO?>" data-url=""><img src="<?=base_url()?>public/images/icon_kakao.png"><br>카카오톡</a></li>
