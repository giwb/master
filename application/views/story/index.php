          ...
          <article id="post-<?=$viewStory['idx']?>">
            ...
            <div class="story-reaction">
              ...
              <div class="area-share">
                <ul>
                  <li><a href="javascript:;" class="btn-share-sns" data-idx="<?=$viewStory['idx']?>" data-type="<?=TYPE_SHARE_FACEBOOK?>" data-url="https://facebook.com/sharer/sharer.php?u=<?=base_url()?>story/view/<?=$view['idx']?>?n=<?=$viewStory['idx']?>"><img src="<?=base_url()?>public/images/icon_facebook.png"><br>페이스북</a></li>
                  <li><a href="javascript:;" class="btn-share-sns" data-idx="<?=$viewStory['idx']?>" data-type="<?=TYPE_SHARE_TWITTER?>" data-url="https://twitter.com/intent/tweet?url=<?=base_url()?>story/view/<?=$view['idx']?>?n=<?=$viewStory['idx']?>"><img src="<?=base_url()?>public/images/icon_twitter.png"><br>트위터</a></li>
                  <li><a href="javascript:;" class="btn-share-url" data-idx="<?=$viewStory['idx']?>" data-type="<?=TYPE_SHARE_URL?>" data-trigger="click" data-placement="bottom" data-clipboard-text="<?=base_url()?>story/view/<?=$view['idx']?>?n=<?=$viewStory['idx']?>"><img src="<?=base_url()?>public/images/icon_url.png"><br>URL</a></li>
                </ul>
              </div>
            </div>
