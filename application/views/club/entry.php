...
<section id="subpage">
  <div class="sub-header">
    ...
    <div class="right">
      <a href="<?=base_url()?>club"><button class="btn-back">목록으로</button></a>
    </div>
  </div>
...
<?php endif; ?>
      ...
      <dl>
        <dt>홈페이지</dt>
        <dd><input type="text" name="homepage" value="<?=$view['homepage']?>" class="width-half"></dd>
      </dl>
      <dl>
        <dt>연락처</dt>
        <dd><input type="text" name="phone" value="<?=$view['phone']?>" class="width-half"></dd>
      </dl>
      <dl>
...
<?php foreach ($view['club_geton'] as $value): if ($value != ''): ?>
            <div class="club-geton-element"><input readonly type="text" name="club_geton[]" class="width-half" value="<?=$value?>"> <button type="button" class="btn-club-geton-delete">삭제</button></div>
<?php endif; endforeach; ?>
          </div>
          <input type="text" name="club_geton[]" class="club-geton-text width-half"> <button type="button" class="btn-club-geton">추가</button>
        </dd>
      </dl>
      <dl>
        <dt>하차위치</dt>
...
<?php foreach ($view['club_getoff'] as $value): if ($value != ''): ?>
            <div class="club-getoff-element"><input readonly type="text" name="club_getoff[]" class="width-half" value="<?=$value?>"> <button type="button" class="btn-club-getoff-delete">삭제</button></div>
<?php endif; endforeach; ?>
          </div>
          <input type="text" name="club_getoff[]" class="club-getoff-text width-half"> <button type="button" class="btn-club-getoff">추가</button>
        </dd>
      </dl>
