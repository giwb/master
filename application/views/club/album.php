      ...
      <div id="album" class="club-main">
        ...
        <div class="sub-content">
          <form method="post" action="<?=BASE_URL?>/album" class="row align-items-center m-0 mb-3">
            ...
            <div class="col-2 col-sm-2 p-0 pl-2"><button class="btn btn-sm btn-default w-100">검색</button></div>
            <div class="col-2 col-sm-2 p-0 pl-2"><a href="<?=BASE_URL?>/album/entry"><button type="button" class="btn btn-sm btn-default w-100">등록</button></a></div>
          </form>
          <form id="formList">
