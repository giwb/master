        ...
        <div class="col-md-12">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-7 text-right">
              <a href="<?=BASE_URL?>/album/entry" class="btn-custom btn-giwbblue" rel="nofollow">사진등록</a>
              <a href="<?=BASE_URL?>/album/delete" class="btn-custom btn-giwbred" rel="nofollow">삭제</a>
            </div>
            <?php endif; ?>
          </div>
          ...
          <div class="d-block d-sm-none">
            <div class="header-menu mt-3">
              ...
              <div class="header-menu-item"><a href="<?=BASE_URL?>/album/best">추천 사진</a></div>
          ...
          <form id="formList">
            <div id="album">
              ...
              <?php if (!empty($cntAlbum['cnt']) && $cntAlbum['cnt'] > $perPage): ?>
                <div class="row mt-5">
                  <div class="col-3"></div>
                  <div class="col-6"><button type="button" class="btn btn-page-next" rel="nofollow">다음 페이지 보기 ▼</button></div>
                  <div class="col-3"></div>
                </div>
              <?php endif; ?>
            </div>
