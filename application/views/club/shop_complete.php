<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
      ...
      <div id="shop" class="club-main">
        ...
        <div class="sub-header">용품판매 - 구매완료</div>
        <div class="sub-content">
          <div class="m-3 p-5 text-center">
            <h2 class="text-info">구매해 주셔서 감사합니다!</h2>
          </div>
          <h4 class="border-bottom m-0 pb-3">■ 구매한 상품</h4>
          <?php $totalAmount = 0; $totalCost = 0; foreach ($listCart as $value): $totalAmount += $value['amount']; $totalCost += $value['item_cost'] * $value['amount']; ?>
          ...
          <div class="row align-items-center border-bottom p-3">
            ...
            <div class="col-3 col-md-2 p-0 text-right item-cost"><?=number_format($value['item_cost'] * $value['amount'])?>원</div>
          </div>
          <?php endforeach; ?>
