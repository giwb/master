<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
  ...
  <input type="hidden" name="redirectUrl" value="<?=!empty($_SERVER['REQUEST_URI']) && $_SERVER['REQUEST_URI'] != '/' . substr($_SERVER['REQUEST_URI'], 1) ? BASE_URL . substr($_SERVER['REQUEST_URI'], 1) : BASE_URL?>">
