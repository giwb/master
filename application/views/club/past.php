    ...
    <div class="container-fluid club-main">
      <div class="row mt-1 mb-5">
        <div class="col-xl-8 col-md-12">
          <h4 class="font-weight-bold">지난 산행보기</h4>
          <hr class="text-default">

          <div class="d-block d-sm-none">
            <div class="header-menu mt-3 mb-3">
              <?php foreach ($listAbout as $value): ?>
              <div class="header-menu-item col-6"><a href="<?=BASE_URL?>/club/about/<?=$value['idx']?>"><?=$value['title']?></a></div>
              <?php endforeach; ?>
              <div class="header-menu-item col-6 active"><a href="<?=BASE_URL?>/club/past">지난산행</a></div>
            </div>
          </div>
          ...
          <form id="formSearch" method="get" action="<?=BASE_URL?>/club/past" class="row border no-gutters align-items-center text-center pt-2 pb-2 pr-2 mt-3 mb-3">
            <ul class="box-past-search">
              ...
              <li><button class="btn btn-sm btn-<?=$view['main_color']?> pl-3 pr-3">검색</button></li>
            </ul>
          </form>
