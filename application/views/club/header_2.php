        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink4">
              ...
              <a class="dropdown-item" href="<?=BASE_URL?>/club/status?type=1">포인트 적립</a>
              <a class="dropdown-item" href="<?=BASE_URL?>/club/status?type=2">산행 참여</a>
              <a class="dropdown-item" href="<?=BASE_URL?>/club/status?type=3">백산백소 인증</a>
              <?php if (!empty($userData['admin']) && $userData['admin'] == 1): ?><a class="dropdown-item" href="<?=BASE_URL?>/club/status?type=4">홈페이지 방문</a><?php endif; ?>
            </div>
          </li>
          <?php if (empty($userData['idx'])): ?>
