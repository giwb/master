...
<body id="page-top" class="fixed-sn homepage-v2">
  ...
  <header>
    <nav id="mainNav" class="navbar navbar-expand-lg navbar-dark">
      <a class="navbar-brand" href="<?=BASE_URL?>"><h2><img width="45" src="/public/images/icon.png" align="left" style="margin-right: 10px;"> 경인웰빙</h2></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="<?=BASE_URL?>/club/auth_page?type=mountain">경인웰빙 100대명산</a>
              <a class="dropdown-item" href="<?=BASE_URL?>/club/auth_page?type=forest">경인웰빙 100대명소</a>
