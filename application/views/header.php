        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="/place">전체보기</a>
              <a class="dropdown-item" href="/place/forest">산림청 100대 명산</a>
              <a class="dropdown-item" href="/place/bac">블랙야크 명산 100</a>
            </div>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="/club">전체보기</a>
              <a class="dropdown-item" href="/club/?=area_sido&k=11000">서울특별시</a>
              <a class="dropdown-item" href="/club/?=area_sido&k=12000">부산광역시</a>
              <a class="dropdown-item" href="/club/?=area_sido&k=13000">대구광역시</a>
              <a class="dropdown-item" href="/club/?=area_sido&k=14000">인천광역시</a>
              <a class="dropdown-item" href="/club/?=area_sido&k=15000">광주광역시</a>
              <a class="dropdown-item" href="/club/?=area_sido&k=16000">대전광역시</a>
              <a class="dropdown-item" href="/club/?=area_sido&k=17000">울산광역시</a>
              <a class="dropdown-item" href="/club/?=area_sido&k=19000">경기도</a>
              <a class="dropdown-item" href="/club/?=area_sido&k=20000">강원도</a>
              <a class="dropdown-item" href="/club/?=area_sido&k=22000">충청도</a>
              <a class="dropdown-item" href="/club/?=area_sido&k=24000">전라도</a>
              <a class="dropdown-item" href="/club/?=area_sido&k=26000">경상도</a>
              <a class="dropdown-item" href="/club/?=area_sido&k=27000">제주도</a>
            </div>
          </li>
          ...
          <?php else: ?>
          <li class="nav-item">
            <a href="/login/check" class="nav-link" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user-plus"></i> 회원가입</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-search" aria-labelledby="navbarDropdownMenuLink">
              <div class="row align-items-center">
                <div class="col-9 pl-4 pr-0"><input type="text" class="form-control"></div>
                <div class="col-3 pl-0 text-center"><button class="btn btn-primary pt-2 pb-2 pl-3 pr-3">검색</button>
              </div>
            </div>
          </li>
        </ul>
