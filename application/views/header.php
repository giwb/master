      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
            ...
            <a class="dropdown-item" href="<?=base_url()?>place?code=<?=$value['code']?>"><?=$value['name']?></a>
            <?php endforeach; ?>
          </div>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a href="javascript:;" class="nav-link btn-logout" aria-haspopup="true" aria-expanded="false"><i class="fas fa-sign-out-alt"></i> 로그아웃</a>
        </li>
        <?php else: ?>
        <li class="nav-item">
