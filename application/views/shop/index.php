<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
      ...
      <div id="shop" class="club-main">
        ...
        <div class="row align-items-center">
          <div class="col-9"><a href="javascript:;" class="btn-notice" data-idx="1"><strong><i class="fa fa-question-circle-o" aria-hidden="true"></i> 구매대행 상품이란..?</strong></a></div>
          <div class="col-3 text-right"><a href="<?=BASE_URL?>/shop/cart"><button type="button" class="btn btn-sm btn-cart">장바구니 보기</button></a></div>
        </div>
