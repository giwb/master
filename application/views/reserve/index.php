                ...
                <table>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th colspan="4" style="border-left: 0px;" class="text-right">출입구 (예약 : <?=$maxRes?>명)</th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <th colspan="4" style="border-left: 0px;" class="text-right">보조석 (<?=getBusAssist($notice['bus_assist'], $bus)?>)</th>
                    </tr>
                    <?php endif; ?>
                    <?php
                        // 버스 형태 좌석 배치
                    ...
                    <?=$tableMake?>
                      ...
                      <td class="<?=$reserveInfo['class']?>" data-id="<?=$reserveInfo['idx']?>"<?=!empty($reserveInfo['priority']) ? ' data-priority="' . $reserveInfo['priority'] . '"' : ''?> <?=!empty($reserveInfo['honor']) ? ' data-honor="' . $reserveInfo['honor'] . '"' : ''?> data-bus="<?=$bus?>" data-seat="<?=$seat?>"><?=!empty($reserveInfo['status']) && $reserveInfo['status'] == 1 ? '<font color="#393939">■</font>' : '□' ?> <?=$reserveInfo['nickname']?><?=!empty($reserveInfo['honor']) && $reserveInfo['nickname'] != '1인우등' ? '<small>(우등)</small>' : ''?></td>
                    <?php endforeach; ?>
                  </tbody>
                </table>
              </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body text-center">
                <iframe src="" frameborder="0" class="area-frame"></iframe><br>
