<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
      ...
      <div class="club-main">
        ...
        <div class="sub-contents">
          ...
          <?php if (!empty($notice['type'])): ?><div class="ti"><strong>・유형</strong> : <?=getNoticeType($notice['type'])?></div><?php endif; ?>
