            ...
            <div class="row mb-4">
              <div class="col-md-6 text-left mt-3">
                <div class="card">
                  ...
                  <div class="card-body">                    
                    <h4 class="card-title"><strong><a href="detail.html"><i class="fas fa-crown pr-1" style="color:silver;"></i>가리왕산<br><small class="grey-text">강원 정선군, 평창군 / 1,561m</small></a></strong></h4><hr>
                  ...
                  <div class="mdb-color lighten-3 text-center">
                    <ul class="list-unstyled list-inline font-small mt-3">
                      <li class="list-inline-item pr-2"><a href="detail.html" class="white-text"><i class="far fa-eye pr-1"></i>조회 24</a></li>
                      <li class="list-inline-item pr-2"><a href="detail.html" class="white-text"><i class="far fa-comments pr-1"></i>댓글 0</a></li>
                      <li class="list-inline-item"><a href="detail.html" class="white-text"><i class="fas fa-crown pr-1"></i>랭킹 2위</a></li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="col-md-6 my-3">
                <div class="card">
                  ...
                  <div class="card-body">
                    <h4 class="card-title"><strong><a href="detail.html"><i class="fas fa-crown pr-1" style="color:#CE7430;"></i>가리산<br><small class="grey-text">강원 춘천시, 홍천군 / 1,051m</small></a></strong></h4><hr>
                    <p class="card-text text-justify">강원도에서 진달래가 가장 많이 피는 산으로 알려져 있고, 참나무 중심의 울창한 산림과 부드러운 산줄기 등 우리나라 산의 전형적인 모습을 갖추고 있으며, 홍천강의 발원지 및 소양강의 수원(水源)을 이루고 있는 점 등을...</p>
                  </div>
                  <div class="mdb-color lighten-3 text-center">
                    <ul class="list-unstyled list-inline font-small mt-3">
                      <li class="list-inline-item pr-2"><a href="detail.html" class="white-text"><i class="far fa-eye pr-1"></i>조회 24</a></li>
                      <li class="list-inline-item pr-2"><a href="detail.html" class="white-text"><i class="far fa-comments pr-1"></i>댓글 0</a></li>
                      <li class="list-inline-item"><a href="detail.html" class="white-text"><i class="fas fa-crown pr-1"></i>랭킹 3위</a></li>
                    </ul>
                  </div>
                </div>
              </div>
