      ...
      <div class="club-main">
        <div class="memberForm">
          ...
          <div class="text-center mt-5">
            <a href="http://kauth.kakao.com/oauth/authorize?client_id=ac8c155b86aa3885c643ba50a7cd4442&redirect_uri=https://giwb.kr/login/oauth&response_type=code"><img src="https://developers.kakao.com/assets/img/about/logos/kakaologin/kr/kakao_account_login_btn_medium_narrow.png"></a>
          </div>
          <?php endif; ?>
        </div>
        <div class="ad-sp">
