      ...
      <div class="col-12 col-sm-6">
        <form class="loginForm pl-4 pr-4" method="post">
          ...
          <div class="text-center mt-3">
            <a href="<?=BASE_URL?>/login/oauth/?provider=kakao&redirectUri=<?=BASE_URL?>/<?=API_KAKAO_URL?>"><img src="https://developers.kakao.com/assets/img/about/logos/kakaologin/kr/kakao_account_login_btn_medium_narrow.png"></a>
          </div>
        </form>
      </div>
      <div class="col-sm-3"></div>
