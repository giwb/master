...
<div class="row align-items-center border-top pt-3 pb-3 pl-2 pr-2 w-100">
  <div class="col-sm-11">
    <strong><?=$value['header']?></strong> <?=$value['subject']?> - <a <?=!empty($value['userid']) ? 'target="_blank" href="/admin_old/member_view/' . $value['userid'] . '"' : 'href="javascript:;"'?>><strong><?=$value['nickname']?>님</strong></a>
