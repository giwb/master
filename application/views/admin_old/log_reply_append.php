<?php
  foreach ($listReply as $value):
    if ($value['reply_type'] == REPLY_TYPE_STORY):  $url = '/story/view/?n=' . $value['story_idx']; endif;
    if ($value['reply_type'] == REPLY_TYPE_NOTICE): $url = '/admin_old/main_view_progress/' . $value['story_idx']; endif;
