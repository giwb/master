    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">계획중 산행 목록</h1>
        </div>
...
?>
            <tr>
              <td>
                <b><?=viewStatus($value['status'])?></b> <a target="_blank" href="/admin_old/main_view_progress/<?=$value['idx']?>"><?=$value['subject']?></a><br>
              ...
              <td align="right">
                ...
                <?php endif; ?>
                <a href="/admin_old/main_entry/<?=$value['idx']?>"><button type="button" class="btn btn-primary">수정</button></a>
                <a href="/admin_old/main_notice/<?=$value['idx']?>"><button type="button" class="btn btn-primary">공지</button></a>
