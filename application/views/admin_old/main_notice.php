<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
    ...
    <div class="border-top border-bottom mt-4 mb-4 pt-3 pb-3 row align-items-center">
      <div class="col-sm-9 area-btn">
        ...
        <a href="/admin_old/main_notice/<?=$view['idx']?>"><button type="button" class="btn btn-secondary">공지</button></a>
    ...
    <form id="myForm" method="post" action="/admin_old/main_notice_update" enctype="multipart/form-data" class="mb-5 pb-5">
