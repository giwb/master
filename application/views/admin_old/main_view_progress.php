    ...
    <div class="sub-contents">
      ...
      <div class="area-reservation">
        <div class="border-top border-bottom mt-4 pt-3 pb-3 row align-items-center">
          <div class="col-sm-9 area-btn">
            ...
            <a href="/admin_old/main_view_adjust/<?=$view['idx']?>"><button type="button" class="btn btn-primary">정산</button></a>
            <?php endif; ?>
          </div>
          <div class="col-sm-3">
        ...
        <form id="reserveForm" method="post" action="/admin_old/reserve_complete">
      ...
      <div class="border-top mt-5 mb-5">
        ...
        <div class="border-top pt-2 pb-2">
          <b><?=viewStatus($value['status'])?></b> <a href="/admin_old/main_view_progress/<?=$value['idx']?>"><?=$value['subject']?></a><br>
