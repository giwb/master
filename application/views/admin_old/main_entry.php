<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
    ...
    <div class="border-top border-bottom mt-4 mb-4 pt-3 pb-3 row align-items-center">
      <div class="col-sm-9 area-btn">
        <a href="/admin_old/main_entry/<?=$view['idx']?>"><button type="button" class="btn btn-secondary">수정</button></a>
    ...
    <form id="myForm" method="post" action="/admin_old/main_entry_update">
    ...
    <script type="text/javascript">
      ...
      $(document).on('change', '.area-sido', function() {
        ...
        $.ajax({
          url: '/admin_old/main_entry_notice',
          data: 'idx=' + $(this).val(),
          dataType: 'json',
          type: 'post',
          success: function(result) {
            ...
            if (typeof result.sido != 'undefined') {
              $.each(result.sido, function(i1, v1) {
                $.ajax({
                  url: '/admin_old/main_entry_notice_area',
                  data: 'sido=' + v1,
                  dataType: 'json',
                  type: 'post',
