      ...
      <div class="area-reservation">
        <div class="area-btn">
          <div class="float-left">
            <a href="/admin_old/main_view_progress/<?=$view['idx']?>"><button type="button" class="btn btn-secondary">예약</button></a>
            <a href="/admin_old/main_view_boarding/<?=$view['idx']?>"><button type="button" class="btn btn-secondary">승차</button></a>
            <a href="/admin_old/main_view_adjust/<?=$view['idx']?>"><button type="button" class="btn btn-secondary">정산</button></a>
            <a href="/admin_old/main_view_sms/<?=$view['idx']?>"><button type="button" class="btn btn-secondary">문자</button></a>
          </div>
          <div class="float-right">
          </div>
        </div>
        <form id="changeSeatForm" method="post" action="/admin_old/reserve_change_seat">
<?php
  // 이번 산행에 등록된 버스 루프
  $bus = 0;
  $cnt = 0;
