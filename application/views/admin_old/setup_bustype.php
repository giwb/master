<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
    ...
    <div class="text-right pt-3 pb-3"><a href="/admin_old/setup_bustype_add"><button class="btn btn-primary">등록하기</button></a></div>
      ...
      <div id="sortable">
        ...
        <div class="row align-items-center border-top mt-3 pt-3 bus-list" data-idx="<?=$value['idx']?>">
          ...
          <div class="col-2 col-sm-2 pl-0 pr-0">
            <a href="/admin_old/setup_bustype_add/<?=$value['idx']?>"><button class="btn btn-sm btn-primary">수정</button></a>
      ...
      $(function() {
        $('#sortable').disableSelection().sortable({
          stop: function(event, ui) {
            ...
            $.ajax({
              url: '/admin_old/setup_bustype_sort',
              data: 'sort=' + arrSort,
              dataType: 'json',
              type: 'post',
              success: function() {}
