                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-link="<?=base_url()?>place/view/<?=$value['idx']?>" class="area-link">
                                            ...
                                            <td class="text-center"><?php if (strstr($value['category'], '{')): $category = unserialize($value['category']); foreach ($category as $cat): echo getPlaceCategoryName($cat) . "<br>"; endforeach; endif; ?></td>
                                            <td><?=$value['title']?></td>
