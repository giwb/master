<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
        ...
        <div id="content" class="mb-5">
          <div class="text-right pt-3 pb-3"><a href="<?=BASE_URL?>/admin/setup_bustype_add"><button class="btn-custom btn-giwb">차종 등록하기</button></a></div>
          <input type="hidden" name="back_url" value="setup_bustype">
          <div class="row no-gutters align-items-center font-weight-bold border-top pt-3">
          ...
          <div id="sortable">
            ...
            <div class="row no-gutters align-items-center border-top mt-3 pt-3 bus-list" data-idx="<?=$value['idx']?>">
              ...
              <div class="col-2 col-sm-1 pl-0 pr-0">
                <div class="mb-1"><a href="<?=BASE_URL?>/admin/setup_bustype_add/<?=$value['idx']?>"><button class="btn-custom btn-giwbblue">수정</button></a></div>
                <div class="mb-1"><button class="btn-custom btn-gray btn-bus-hide" data-idx="<?=$value['idx']?>"><?=$value['visible'] == 'Y' ? '숨김' : '보임'?></button></div>
                <div class="mb-0"><button class="btn-custom btn-giwbred btn-bustype-delete-modal" data-idx="<?=$value['idx']?>">삭제</button></div>
              </div>
            </div>
            <?php endforeach; ?>
          </div>
