<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
        ...
        <div id="content" class="mb-5">
          ...
          <form id="formAdjust" method="post" action="/admin/main_view_adjust_update">
            ...
            <div class="row no-gutters align-items-center mt-4 pt-2 pb-2 border-top border-bottom text-center bg-info text-white font-weight-bold">
              <div class="col-1">&nbsp;</div>
            ...
            <!-- 할인 -->
            <div class="row no-gutters align-items-center mt-1 p-1 pt-2 border-top">
              <div class="col-1"></div>
            ...
            <div class="row no-gutters align-items-center mt-1 p-1 pt-2 pb-2 border-top border-bottom text-center bg-info text-white font-weight-bold">
            ...
            <div class="row no-gutters align-items-center p-1 text-center">
