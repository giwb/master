<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
        ...
        <div id="content" class="mb-5">
          ...
          <div class="row align-items-center mt-1 p-1 pt-2 border-top">
            ...
            <div class="col-1 pl-1 pr-1"><input readonly type="text" name="amount4" class="form-control form-control-sm text-right"></div>
            <div class="col-2 pl-1 pr-1"><input readonly type="text" name="cost4" class="form-control form-control-sm text-right"></div>
            <div class="col-2 pl-1 pr-1"><input readonly type="text" name="total4" class="form-control form-control-sm text-right"></div>
          ...
          <div class="row align-items-center p-1">
            ...
            <div class="col-1 pl-1 pr-1"><input readonly type="text" name="amount5" class="form-control form-control-sm text-right"></div>
            <div class="col-2 pl-1 pr-1"><input readonly type="text" name="cost5" class="form-control form-control-sm text-right"></div>
            <div class="col-2 pl-1 pr-1"><input readonly type="text" name="total5" class="form-control form-control-sm text-right"></div>
          ...
          <div class="mt-1 pt-3 border-top text-center">
            <button class="btn btn-default">정산내역저장</button>
          </div>
        </div>
