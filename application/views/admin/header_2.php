...
<head>
  ...
  <meta property="og:title" content="<?=!empty($viewClub['title']) ? $viewClub['title'] : '한국여행 :: TripKorea.net'?>" />
...
<body id="page-top" class="fixed-sn homepage-v2">
  ...
  <header>
    <nav id="mainNav" class="navbar navbar-expand-lg navbar-dark">
      <a class="navbar-brand" href="<?=BASE_URL?>"><img width="45" src="/public/images/icon.png" style="margin-right: 10px; float: left;"><span class="logo"><?=!empty($viewClub['title']) ? $viewClub['title'] : '한국여행'?></span></a>
