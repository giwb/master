<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <form id="formSearch" method="post" action="/admin/log_visitor" class="mb-3 pb-3 visitor-header">
      ...
      <div class="row align-items-center border-top pt-2 pb-2 small visitor-data">
        ...
        <div class="col-sm-1"><?=!empty($value['nickname']) && empty($value['quitdate']) ? '<a href="/admin/member_view/' . $value['created_by'] . '">' . $value['nickname'] . '</a>' : $value['ip_address']?></div>
