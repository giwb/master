...
<dl>
  <dt>[<?=$value['idx']?>] <a href="<?=BASE_URL?>/admin/member_view/<?=$value['idx']?>" class="<?=$value['gender'] == 'M' ? 'text-primary' : 'text-danger'?>"><?=$value['realname']?> / <?=$value['nickname']?> / <?=$value['userid']?> / <?=$level['levelName']?> (<?=$value['level']?>점)</a></dt>
