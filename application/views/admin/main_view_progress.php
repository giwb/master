      ...
      <div class="area-reservation">
        <div class="area-btn">
          <div class="float-left">
            <button type="button" class="btn btn-secondary">승차관리</button>
            <button type="button" class="btn btn-secondary">정산관리</button>
            <button type="button" class="btn btn-secondary">좌석문자양식</button>
          </div>
