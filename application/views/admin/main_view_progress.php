                ...
                <table>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th colspan="4" style="border-left: 0px;" class="text-right">출입구 (예약 : <?=cntRes($view['idx'], $bus)?>명)</th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <th colspan="4" style="border-left: 0px;" class="text-right">보조석 (<?=getBusAssist($view['bus_assist'], $bus)?>)</th>
                    </tr>
                    <?php endif; ?>
                    <?php
                        // 버스 형태 좌석 배치
