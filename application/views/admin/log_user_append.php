...
<div class="row align-items-center border-top pt-3 pb-3 w-100">
  <div class="col-sm-11 p-0">
    <strong><?=$value['header']?></strong> <?=$value['subject']?> - <a <?=!empty($value['userid']) ? 'target="_blank" href="/admin/member_view/' . $value['userid'] . '"' : 'href="javascript:;"'?>><strong><?=$value['nickname']?>님</strong></a>
