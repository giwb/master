<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
        ...
        <div id="content" class="mb-5">
          <div class="w-100 border mt-3 mb-3">
            <form id="formSearch" method="get" action="/admin/main_list_canceled">
          ...
          <div class="row align-items-center border-bottom mb-3 pb-3">
            ...
            <div class="col-2 col-sm-1 text-right"><a href="/admin/main_list_canceled?<?=$search['prev']?>">◀</a></div>
            ...
            <div class="col-2 col-sm-1"><a href="/admin/main_list_canceled?<?=$search['next']?>">▶</a></div>
            <div class="col-sm-2 d-none d-sm-block"></div>
          </div>
