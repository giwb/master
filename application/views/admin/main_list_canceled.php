    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="w-100 border mt-2 mb-3 p-3">
          <form id="formSearch" method="get" action="<?=base_url()?>admin/main_list_canceled" class="row align-items-center text-center">
        ...
        <div class="row align-items-center border-bottom mb-3 pb-3">
          ...
          <div class="col-lg-1 text-right"><a href="<?=base_url()?>admin/main_list_canceled?<?=$search['prev']?>">◀</a></div>
          <div class="col-lg-1">
          ...
          <div class="col-lg-1"><a href="<?=base_url()?>admin/main_list_canceled?<?=$search['next']?>">▶</a></div>
          <div class="col-lg-4"></div>
        </div>
<?php
