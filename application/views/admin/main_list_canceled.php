        ...
        <div id="content" class="mb-5">
          <div class="w-100 border mt-3 mb-3">
            <form id="formSearch" method="get" action="<?=BASE_URL?>/admin/main_list_canceled">
              <div class="row no-gutters align-items-center w-100 pt-3 text-center">
                <div class="col-3 col-sm-2">시작일</div>
                <div class="col-8 col-sm-3"><input id="startDatePicker" type="text" name="sdate" class="form-control form-control-sm" value="<?=!empty($search['sdate']) ? $search['sdate'] : ''?>"></div>
                <div class="w-100 d-block d-sm-none pt-2"></div>
                <div class="col-3 col-sm-2">종료일</div>
                <div class="col-8 col-sm-3"><input id="endDatePicker" type="text" name="edate" class="form-control form-control-sm" value="<?=!empty($search['edate']) ? $search['edate'] : ''?>"></div>
              </div>
              <div class="row no-gutters align-items-center w-100 pt-2 pb-3 text-center">
                <div class="col-3 col-sm-2">검색어</div>
                <div class="col-8 col-sm-8"><input type="text" name="subject" class="form-control form-control-sm" value="<?=!empty($search['subject']) ? $search['subject'] : ''?>"></div>
                <div class="w-100 d-block d-sm-none pt-2"></div>
                <div class="col-sm-2 text-center"><button class="btn-custom btn-giwb pl-5 pr-5">검색</button></div>
              </div>
            </form>
          </div>
          ...
          <div class="border-top pt-4 pb-5 text-center">
            등록된 산행이 없습니다.
          </div>
          <?php else: foreach ($listCancel as $value): ?>
          <div class="row no-gutters mb-3 pt-3 border-top">
            <div class="col-9">
            ...
            <div class="col-3 text-right small">0원<br><?=cntRes($value['idx'])?>명</div>
          </div>
